...
import engine.utilities.ThreadPool;
 ...
 * <ul>
 * <li>add a setMasterVolume() method, which uses Controls to s	et the volume for
 * each line.
 * <li>don't play a sound if more than, say, 500ms have passed since the request
 * to play
 * </ul>
 */
public class SoundManager extends ThreadPool {

	private AudioFormat playbackFormat = Game.PLAYBACK_FORMAT;
	...
	private SoundManager() {
		super(getMaxSimultaneousSounds(Game.PLAYBACK_FORMAT));
	}

	public void init() {
		soundManager = new SoundManager(Game.PLAYBACK_FORMAT,
	 ...
	 * sounds.
	 */
	private SoundManager(AudioFormat playbackFormat) {
		this(Game.PLAYBACK_FORMAT, getMaxSimultaneousSounds(playbackFormat));
	}/*
	 * 
	...
	private SoundManager(AudioFormat playbackFormat, int maxSimultaneousSounds) {
