 ...
 * 160-193
 */
public class PR4 extends RoomManager {
	public FourSidedPhotoRoom fspr0, fspr1, fspr2, fspr3;

	public PR4(Sandbox sandbox) {
		super(sandbox);

		maxRooms = 4;
		pRooms = new PhotoRoom[maxRooms];

		fspr0 = new FourSidedPhotoRoom(getSandbox(), this, "beginning/16");
		fspr0.forward.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent event) {
				nextPhotoRoom(new PR5(getSandbox()));
			}
		});
		pRooms[0] = fspr0;
	...
	public void createFirstRoom() {
		fspr1 = new FourSidedPhotoRoom(getSandbox(), this, "beginning/17");
	...
	public void createSecondRoom() {
		fspr2 = new FourSidedPhotoRoom(getSandbox(), this, "beginning/18");
	...
	public void createThirdRoom() {
		fspr3 = new FourSidedPhotoRoom(getSandbox(), this, "beginning/19");
