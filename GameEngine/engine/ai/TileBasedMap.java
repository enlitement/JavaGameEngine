...
public interface TileBasedMap {
	 ...
	 * tile.
	 * @param gx The x coordinate of the grid to check
	 * @param gy The y coordinate of the grid to check
	 * @param tx The x coordinate of the tile to check
	 * @param ty The y coordinate of the tile to check
